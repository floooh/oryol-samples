...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "BulletPhysicsBasic.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "BulletPhysicsBasic.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "BulletPhysicsBasic.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 47376;
__ATINIT__.push({
 func: (function() {
  __GLOBAL__sub_I_btQuickprof_cpp();
 })
});
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "BulletPhysicsBasic.html.mem" : null;
var STATIC_BUMP = 47376;
...
staticSealed = true;
Module["wasmTableSize"] = 949;
Module["wasmMaxTableSize"] = 949;
