...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "ImGuiDemo.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "ImGuiDemo.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "ImGuiDemo.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 77472;
__ATINIT__.push({
 func: (function() {
  __GLOBAL__sub_I_imgui_cpp();
 })
});
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "ImGuiDemo.html.mem" : null;
var STATIC_BUMP = 77472;
...
staticSealed = true;
Module["wasmTableSize"] = 101;
Module["wasmMaxTableSize"] = 101;
