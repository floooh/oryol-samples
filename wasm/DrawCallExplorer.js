...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "DrawCallExplorer.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "DrawCallExplorer.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "DrawCallExplorer.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 49840;
__ATINIT__.push({
 func: (function() {
  __GLOBAL__sub_I_imgui_cpp();
 })
});
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "DrawCallExplorer.html.mem" : null;
var STATIC_BUMP = 49840;
...
staticSealed = true;
Module["wasmTableSize"] = 97;
Module["wasmMaxTableSize"] = 97;
