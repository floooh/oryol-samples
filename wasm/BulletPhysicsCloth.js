...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "BulletPhysicsCloth.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "BulletPhysicsCloth.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "BulletPhysicsCloth.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 47776;
__ATINIT__.push({
 func: (function() {
  __GLOBAL__sub_I_btQuickprof_cpp();
 })
});
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "BulletPhysicsCloth.html.mem" : null;
var STATIC_BUMP = 47776;
...
staticSealed = true;
Module["wasmTableSize"] = 957;
Module["wasmMaxTableSize"] = 957;
