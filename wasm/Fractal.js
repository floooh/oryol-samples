...
function integrateWasmJS(Module) {
 ...
 var wasmTextFile = Module["wasmTextFile"] || "Fractal.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "Fractal.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "Fractal.temp.asm.js";
...
var ASM_CONSTS = [];
STATIC_BASE = 1024;
STATICTOP = STATIC_BASE + 53872;
__ATINIT__.push({
 func: (function() {
  __GLOBAL__sub_I_imgui_cpp();
 })
});
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "Fractal.html.mem" : null;
var STATIC_BUMP = 53872;
